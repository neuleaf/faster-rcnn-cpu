#Note
This ref contains 2 files(`roi_pooling_layer.cpp` and ` smooth_L1_loss_layer.cpp`). They are a copy of [py-faster-rcnn/.../layers](https://github.com/rbgirshick/caffe-fast-rcnn/tree/0dcd397b29507b8314e252e850518c5695efbb83/src/caffe/layers) but with cpu implementation.
This may be help when your GPU doesn't meet the requirements.

More details please see [py-faster-rcnn](https://github.com/rbgirshick/py-faster-rcnn)
### Disclaimer
